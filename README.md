...
| `makeBucketJob.nodeSelector`                   | Node labels for pod assignment (make-bucket-job)                                                                                          | `{}`                             |
| `makeBucketJob.affinity`                   | Affinity settings for pod assignment (make-bucket-job)                                                                                        | `{}`                             |
| `makeBucketJob.tolerations`                   | Toleration labels for pod assignment (make-bucket-job)                                                                                     | `[]`                             |
